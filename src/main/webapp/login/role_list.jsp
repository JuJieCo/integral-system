	  ...
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td  height="22" align="center" background="${pageContext.request.contextPath}/resource/images/bg.gif" bgcolor="#FFFFFF" width="45%"><span class="STYLE1">操作</span></td>
          </tr>
		    <!-- 迭代  第一层-->
		    ...
		    <tr>
	            ...
	            <td height="20" bgcolor="#FFFFFF" align="center">
	            	...
	            	<span class="STYLE1"><a href="${pageContext.request.contextPath}/login/roleAction!showRole?role.uuid=${one.uuid}&type=edit" >修改名称</a></span>
