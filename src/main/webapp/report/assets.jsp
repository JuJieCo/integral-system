...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td >
	  <form action="${pageContext.request.contextPath}/report/reportAction!queryDetailsByTime" name="form1" method="post">
	  <table width="90%"  bgcolor="#EFF6FE">
	  <tr >
	  <td width="35%" class="STYLE4" > 
	  &nbsp;客户姓名 ：<input name="dataDetails.dataCustName" type="text" size="8" value="${dataDetails.dataCustName}"/>
	  &nbsp;&nbsp;&nbsp;&nbsp;身份证号 ：<input name="dataDetails.dataCreditCard" type="text" size="8" value="${dataDetails.dataCreditCard }"/>
	  ...
	  <td  width="30%"  class="STYLE4" > &nbsp;&nbsp;选择月份：<script type="text/javascript">var year = new Date().getFullYear();document.write(year);</script>年
		&nbsp;&nbsp;<select name="dataDetails.dataYm">
			...
			</script>	</select> &nbsp;&nbsp;止&nbsp;&nbsp;<select name="dataDetails.dataHold1">
			<script type="text/javascript">
				var year = new Date().getFullYear();
				var month = new Date().getMonth()+1;
				var i = 0 ;
		...
		</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  value="查询" class="btn_mouseout" onclick="document.forms.form1.submit();"> </td>
