	  ...
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="30%">&nbsp;${integraCusMain.integralCustomer }</td>
		  </tr>
		  <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="30%">&nbsp;${integraCusMain.cust_main_time }</td>
		  </tr>
		  <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="30%">&nbsp;${integraCusMain.cust_integral_totle }</td>
		  </tr>
		  <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="30%">&nbsp;${integraCusMain.cust_integral_calls }</td>
		  </tr>
		  <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="30%">&nbsp;${integraCusMain.cust_integral_remain }</td>
		  </tr>
         <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" colspan="3">&nbsp;<textarea name="notice.content" cols="30" rows="6" readonly="readonly">${integraCusMain.cust_main_remark  }</textarea> </td>
		 </tr>
		  </table>
		</td>
        <td  width="8" background="${pageContext.request.contextPath}/resource/images/tab_15.gif">&nbsp;</td>
