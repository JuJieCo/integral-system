...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>
	  <form action="${pageContext.request.contextPath }/exchangeGifts/exchangeGiftsAction!exchangeGiftsCustInfo" name="form1" method="post">
	  <table width="100%"  bgcolor="#EFF6FE">
	  <tr >
	  <td class="STYLE4" > 
	  <hr>
	  &nbsp;客户姓名 ：<input name="custName" type="text" size="25" value="${custName }"/>
	  &nbsp;&nbsp;客户证件号 ：<input name="custCode" type="text" size="25" value="${custCode }"/>
	  &nbsp;&nbsp;&nbsp;&nbsp;<span class="star">*${message }</span>&nbsp;&nbsp;<input type="button"  value="查询礼品" class="btn_mouseout" onclick="document.forms.form1.submit();">
	  <hr>
	  </td>
	  <td class="STYLE4" > </td>
	  <td class="STYLE4" > </td>
