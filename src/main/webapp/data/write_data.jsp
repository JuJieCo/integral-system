...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td >
	  <form action="${pageContext.request.contextPath}/data/dataAction!queryDataDetailsByCond" name="form1" method="post" style="margin:0px;padding:0px">
	  ...
	  <td class="STYLE4" >
		...
		&nbsp;&nbsp;<select name="dataDetails.dataYm">
   		...
   		&nbsp;客户姓名：<input type="text"  name="dataDetails.dataCustName" value="${dataDetails.dataCustName}"/>
   		&nbsp;证件号码：<input type="text"  name="dataDetails.dataCustCode" value="${dataDetails.dataCustCode}"/>
